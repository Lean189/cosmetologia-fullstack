...
// ⚠️ Cambiá estos valores con los reales del negocio
const INSTAGRAM_URL = "https://www.instagram.com/antolopez.skinstudio";
const WHATSAPP_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "5491122334455";
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=Hola%2C%20me%20gustar%C3%ADa%20saber%20m%C3%A1s%20sobre%20sus%20servicios.`;
    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6 border-t border-pink-700">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mb-1">
            <span className="text-white font-medium">Lunes y Miércoles</span>
          </p>
          <p className="text-gray-400 text-sm">
            10:00 – 18:00 hs
          </p>
          <p className="text-gray-500 text-xs mt-3">
            *Otros días disponibles por consulta
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              <span className="text-sm">@antolopez.skinstudio</span>
            </a>
      ...
      <div className="mt-10 pt-6 border-t border-gray-700 text-center">
        <p className="text-gray-500 text-sm">
          &copy; {CURRENT_YEAR} AntoLopez Skinstudio — Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
